...
# 레퍼런스 DB(v3) — story-v1-scripts repo의 reference/ 디렉터리.
...
# 트렌드서치용 v4 태깅 DB — 봇 전용(sync_reference가 덮어쓰는 data/reference 밖).
REFERENCE_DB_V4 = Path(os.environ.get("COWRITER_REFERENCE_DB_V4", BASE_DIR / "data" / "reference_db_v4.json"))
